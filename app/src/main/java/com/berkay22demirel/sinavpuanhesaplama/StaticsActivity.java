...
public class StaticsActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_settings:
                Intent intentSettings = new Intent(StaticsActivity.this, SettingsActivity.class);
                startActivity(intentSettings);
                break;
            case R.id.action_info:
                Intent intentInfo = new Intent(StaticsActivity.this, InfoActivity.class);
    ...
    private void showAlertDialog() {
        new AlertDialog.Builder(StaticsActivity.this)
                .setTitle("UYARI!")
